...
function FCProREST(host, port, endpoint, username, password){
  this.host = host;
  this.port = port;
  ...
  this._performRequest = function(endpoint, method, data, file, success) {
	  ...
	  if (file != null && typeof file == 'object') {
	    	if (file.type == "download") {
	    		downloadStream = true;
	    		tempName = temp.path({suffix: '.pdf', dir: 'temp/'});
...
*/
FCProREST.prototype.UploadJob = function(ext, settingsName, file, cb) {
...
// LOGIC HANDLER
FCProREST.prototype.UploadWaitFor = function(ext, settingsName, file, cb) {
	var self = this;
	self.UploadJob(ext, settingsName, file, function(data) {
